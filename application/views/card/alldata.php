...
<div class="container-fluid" id="content">
    ...
    <td style="text-align: center">Action</td>
        ...
        <tr>
            ...
            <td style="text-align: center"><a href="<?php echo base_url(); ?>index.php/admin/kartu/cetak_id/<?php echo $data->id_ang ?>" target="_blank"><button class="btn btn-info"><i class="icon-white icon-check"></i>Cetak</button></a></td>
        </tr>
            <?php endforeach;?>
        </tbody>
